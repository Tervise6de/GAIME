...
// but NOT all are beatable by the commander oracle: across 54 swept seeds it
// wins ~83% (45/54); the rest expose bot weaknesses or genuinely harder maps
// (PLAYTEST_LOG 2026-07-11). And difficulty is EMERGENT — no cheap geometry
// feature predicts win-time — so a too-hard map cannot be rejected at
// generation time. The viable normalizer is therefore the offline ORACLE:
// pre-screen seeds with the commander bot and ship ONLY those it wins with a
// comfortable margin. A raw random seed would sometimes hand the player a map
// the oracle itself cannot beat — this pool never does.
//
...
// sample). Regenerate/extend with tools/bot_sweep.mjs (seeds 1000..6141,
...
export const HELD_OUT = [1485, 2067, 2164, 2552, 3716, 4492];
