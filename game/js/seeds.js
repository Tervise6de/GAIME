...
// certified set also holds sub-210s "gentle" maps and one 366s "stiff" map).
// Post-tuning difficulty is already tight (win-times 153-366s, median 251), so
// this is a light selection, not a per-map quota rewrite. Difficulty tiers set
// up a future easy->hard campaign order. Regenerate with the same sweep.
